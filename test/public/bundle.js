var app = (function () {
    ...
    /* test/src/Two.svelte generated by Svelte v3.6.1 */
    const { console: console_1 } = globals;

    const file = "test/src/Two.svelte";

    function create_fragment(ctx) {
    	var h1, t0, t1, t2, t3, button, dispose;
    	...
    	return {
    		c: function create() {
    			...
    			add_location(h1, file, 29, 0, 551);
    			add_location(button, file, 30, 0, 574);
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      onDestroy(() => {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console_1.warn(`<Two> was created with unknown prop '${key}'`);
    	});
    	...
    	return { name, dispatch, click_handler };
    }
    ...
    class Two extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (ctx.name === undefined && !('name' in props)) {
    			console_1.warn("<Two> was created without expected prop 'name'");
    		}
    	}
    ...
    /* test/src/App.svelte generated by Svelte v3.6.1 */
    ...
    function create_if_block(ctx) {
    	...
    	var two = new Two({ props: { name: "bill" }, $$inline: true });
    ...
    function create_fragment$1(ctx) {
    	var h1, t0, t1, t2, t3, button, t5, if_block_anchor, current, dispose;

    	var if_block = (ctx.condition) && create_if_block();
    	...
    	return {
    		c: function create() {
    			...
    			attr(h1, "class", "svelte-1ucbz36");
    			add_location(h1, file$1, 39, 0, 721);
    			add_location(button, file$1, 40, 0, 744);
    			dispose = listen(button, "click", ctx.click_handler);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      onDestroy(() => {
    	...
    	const writable_props = ['name'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console_1$1.warn(`<App> was created with unknown prop '${key}'`);
    	});

    	function click_handler() {
    		const $$result = (condition = !condition);
    		$$invalidate('condition', condition);
    		return $$result;
    	}
    	...
    	$$self.$$.update = ($$dirty = { name: 1, condition: 1 }) => {
    	...
    	return { name, condition, click_handler };
    }
